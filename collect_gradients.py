...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset", choices=["mnist", "cifar", "imagenet", "svhn"], default="mnist", help = "choose dataset")
    ...
    for i, input_img in enumerate(inputs):
        ...
        # dirty hack for MNIST
        if "mnist" in dataset:
            original_predict = predictor(np.stack([np.stack(input_img)]))
        else:
